...
- Using **Azure AI Foundry** for building and deploying Generative AI Applications and Agents.

## 🌱 Currently Learning
- Advanced **deep learning workflows** and **vector databases** like Pinecone, Weaviate, and pgvector.  
- Full lifecycle **production deployment** with **Azure AI Foundry**, Docker and API integrations.  
